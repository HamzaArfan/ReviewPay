        ...
        <div className="max-w-sm w-full text-gray-600 space-y-8 font-['GeneralSansRegular']">
          <div className="text-center">
            ...
            <div className="mt-5 space-y-2">
              <h3 className="text-gray-800 text-2xl font-['GeneralSansBold'] sm:text-3xl">Create New Password</h3>
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            <div>
              <label className="font-['GeneralSansMedium']">New Password</label>
              <input
                type="password"
                required
            ...
            <div>
              <label className="font-['GeneralSansMedium']">Confirm Password</label>
              <input
                type="password"
                required
                className="w-full mt-2 px-3 mb-2 py-2 text-gray-500 bg-transparent outline-none border focus:border- shadow-sm rounded-lg"
